...
CREATE TABLE ReviewComment (ReviewID int(10) NOT NULL, ID int(10) NOT NULL, content text, rating float, PRIMARY KEY (ReviewID, ID), CONSTRAINT UC UNIQUE (ID));
...
CREATE TABLE Pros (ReviewID int(10) NOT NULL, ID int(10) NOT NULL, fact text NOT NULL, PRIMARY KEY (ReviewID, ID), CONSTRAINT UC1 UNIQUE (ID));
CREATE TABLE Cons (ReviewID int(10) NOT NULL, ID int(10) NOT NULL, fact text NOT NULL, PRIMARY KEY (ReviewID, ID), CONSTRAINT UC2 UNIQUE (ID));
...
CREATE TABLE CPU (ProductID int(11) NOT NULL, model text, clock text, MaxTurbo text, integratedGpu text, stockCooler bit(1), manufacturer text, cpuType text, logicalCores int(11), physicalCores int(11));
...
CREATE TABLE Chassis (ProductID int(11) NOT NULL, type text, atx bit(1), miniAtx bit(1), miniItx bit(1), fans int(11), brand text, height text, width text, depth text, weight text);
